/*============================================================
    "Twilight" theme programmatic settings
...
//----------------------------------------
    var currentSkin = isc.setCurrentSkin({
        ...
        name: "autoDetect", 
        series: "Flat",
        // in the Showcase, use the icons/thumbnails/example images from the "Obsidian" skin
        showcaseMediaSkin: "Obsidian",
...
//----------------------------------------
    ...
    isc.Canvas.setProperties({
        ...
        groupBorderCSS: "1px solid #5d5f5f",
